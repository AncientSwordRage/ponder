...
const getDeckSizeConstraints = (deckSize, landCount) => {
    return ['cards', { equal: deckSize - landCount }];
}
 ...
 */
const getCardFormatConstraints = (variablesEntries, maxCardCount) => variablesEntries.filter(([cardName,]) => Boolean(cardName))
